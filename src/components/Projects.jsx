...
const PROJECTS = [
  {
    ...
    imageName: 'toDoList',
    tags: ['React', 'PostCSS'],
    gitUrl: 'https://github.com/bokyungK/making-to-do-list',
  ...
  },
  {
    ...
    gitUrl: 'https://github.com/bokyungK/shoppy',
  ...
  },
  {
    ...
    gitUrl: 'https://github.com/bokyungK/walking-diary',
  ...
  return (
    <Element id="toProject" className="projects">
      ...
      <ol className="project-container">
        {
          PROJECTS.map((item) => {
            const { title, description, imageName, tags, gitUrl, siteUrl } = item;
                  ...
                  <div className="project-content">
                    ...
                    <div>
                      ...
                      <div className="link-container">
                        <a className="url-items" href={gitUrl}>깃헙</a>
